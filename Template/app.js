(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/webgl-group.loader.js";
    var config = {
        dataUrl: buildUrl + "/webgl-group.data",
        frameworkUrl: buildUrl + "/webgl-group.framework.js",
        codeUrl: buildUrl + "/webgl-group.wasm",
